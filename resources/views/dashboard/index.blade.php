                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <div class="card shadow-sm border" style="border-radius: 0.5rem">
                            <div class="card-body">
                                <h5>{{ count($transactions) }} clientes el dia de hoy</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                    ...
                                    <tbody>
                                        @forelse ($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td>{{ Helper::getDateDifference(now(), $transaction->check_out) == 0 ? 'Last Day' :  Helper::getDateDifference(now(), $transaction->check_out). ' '. Helper::plural('Dias', Helper::getDateDifference(now(), $transaction->check_out))}}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span
                                                        ...
                                                        {{ $transaction->getTotalPrice() - $transaction->getTotalPayment() == 0 ? 'Completado' : 'En Progreso' }}
                                                    </span>
                        ...
                        <div class="card shadow-sm border">
                            <div class="card-header border-0">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title">Clientes Mensuales</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
