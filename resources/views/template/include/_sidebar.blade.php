            ...
            @if (auth()->user()->role == 'Super' || auth()->user()->role == 'Admin')
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('room.index') }}">Habitacion</a></li>
                        <li><a class="dropdown-item" href="{{ route('type.index') }}">Tipos</a></li>
                        <li><a class="dropdown-item" href="{{ route('roomstatus.index') }}">Estados</a></li>
                ...
                <li>
                    <a class="nav-link py-3 border-bottom border-right myBtn  dropdown-toggle
                        {{ in_array(Route::currentRouteName(), ['report.index']) ? 'active' : '' }}"
