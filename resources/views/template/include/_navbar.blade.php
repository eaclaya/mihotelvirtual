...
<nav class="navbar navbar-expand navbar-light px-1 bg-white shadow-sm" style="height: 55px">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('img/logo/mhv_rounded.png') }}" alt="" width="40" height="40"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <i class="fas fa-bell">
                            @if (auth()->user()->unreadNotifications->count() > 0)
                                <span
                                    ...
                                    <span class="visually-hidden">mensajes no leidos</span></span>
                            @endif
                        </i>
                    </div>
                </div> -->
                                ...
                                @forelse (auth()->user()->unreadNotifications as $notification)
                                    <li>
                                        <p>
                                            ...
                                            {{-- <a href="{{ $notification->data['url'] }}">Aqui</a> --}}
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <a href="{{ route('notification.markAllAsRead') }}"
                                            class="float-start mb-2 ms-2">Marcar como leido</a>
                                        <a href="{{ route('notification.index') }}" class="float-end mb-2 me-2">Ver todos</a>
                                    </div>
                                </div>
                            </li>
                        </div>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="{{ route('setting.account') }}">Configuracion</a></li>
                    @if(auth()->user()->role == 'Super') 
                    <li><a class="dropdown-item" href="{{ route('setting.invoice') }}">Facturacion</a></li>
                    @endif
                    <li>
