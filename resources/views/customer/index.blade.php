            ...
            <div class="row mt-2 mb-2">
                ...
                <div class="col-lg-6 mb-2">
                    <form class="d-flex" method="GET" action="{{ route('customer.index') }}">
                        <input class="form-control me-2" type="search" placeholder="Buscar por nombre" aria-label="Buscar" id="search"
...
<script>
    $('.delete').click(function() {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Estas seguro?',
            text: customer_name + " sera eliminado y no podras recuperarlo!",
            icon: 'warning',
