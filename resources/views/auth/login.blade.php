...
@section('content')
            ...
            <div class="col-lg-5 col-md-8 col-sm-12  mx-auto" style="z-index: 1">
                <div class="glassmorphism card-signin my-5">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                <div class="d-flex justify-content-center">
                                    <img src="{{ asset('img/logo/mhv_rounded.png') }}" width="100" height="100"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h5 class="card-title text-center">Mi Hotel Virtual</h5>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-label-group">
                                        <input type="password" id="password" name="password" autocomplete="new-password"
                                            class="form-control @error('password') is-invalid @enderror" placeholder="Contraseña" value="{{ old('password') }}"
                                            required>
    ...
    <svg class="wavesbottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#00a99d" fill-opacity="1"
