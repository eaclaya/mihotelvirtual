            ...
            <div class="col-md-8 mt-2">
                <div class="card shadow-sm border">
                    <div class="card-body p-3">
                        <h2>{{ $roomsCount }} habitaciones disponibles:</h2>
                                    ...
                                    <div
                                        ...
                                        <div class="col p-4 d-flex flex-column position-static">
                                            ...
                                            <a href="{{ route('transaction.reservation.confirmation', ['customer' => $customer->id, 'room' => $room->id, 'from' => request()->input('check_in'), 'to' => request()->input('check_out')]) }}"
                                                class="btn myBtn shadow-sm border w-100 m-2">Seleccionar</a>
                                        </div>
                                        <div class="col-auto d-none d-lg-block">
                                            <img src="{{ $room->firstImage() }}" width="250" height="250" alt="">
                                        </div>
                                    </div>
                                </div>
                            @empty
