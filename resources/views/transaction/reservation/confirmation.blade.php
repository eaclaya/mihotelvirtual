                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row mb-3">
                                    <label for="room_price" class="col-sm-2 col-form-label">Precio / Dia</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-sm-12 mt-2">
                                <form method="POST"
                                    ...
                                    <div class="row mb-3">
                                        <label for="how_long" class="col-sm-2 col-form-label">Dias</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="total_price" class="col-sm-2 col-form-label">Total a Pagar</label>
                                        <div class="col-sm-10">
                                    ...
                                    <!-- <div class="row mb-3">
                                        <label for="minimum_dp" class="col-sm-2 col-form-label">Deposito Minimo</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                ...
                                                id="downPayment" name="downPayment" placeholder="Ingresa el monto de pago"
                                    ...
                                    <button type="submit" class="btn btn-primary float-end">Guardar Pago</button>
                                </form>
                            </div>
                        </div>
                    </div>
