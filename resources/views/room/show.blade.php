            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="room_status_id" name="room_status_id" class="form-control select2" onchange="changeRoomStatus(this)">
        ...
        <div class="col-md-4">
            <div class="row row-col-2 row-cols-lg-3 g-3">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>No hay imagen para esta habitacion</h4>
                        </div>
                    </div>
                </div>
                @endforelse
                ...
                <div class="modal-body">
                    <form action="{{ route('image.store', ['room' => $room->id]) }}" method="POST"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button class="input-group-text" type="submit" for="inputGroupFile02">Subir</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('footer')
    <script>
        ...
        function changeRoomStatus(element){
                const room_status_id = element.value;
                axios.get('/room/' + room.id + '/status/' + room_status_id)
                     .then(() => {
                        toastr.success("Estado actualizado correctamente", "Completado");
                     });
            }
    </script>
    @error('image')
