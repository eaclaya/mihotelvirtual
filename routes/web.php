...
Route::group(['middleware' => ['auth', 'checkRole:Super,Admin']], function () {
    ...
    Route::name('setting.')->group(function () {
        ...
        Route::post('/invoice', [InvoiceSettingController::class, 'store'])->name('invoice.store');
    });

    Route::resource('customer', CustomerController::class);
    Route::resource('type', TypeController::class);
    Route::get('room/search/{filter?}', [RoomController::class, 'search'])->name('room.search');
    Route::get('room/{id}/status/{status}', [RoomController::class, 'status'])->name('room.status');
    ...
    Route::get('/transaction/{transaction}/payment/print', [PaymentController::class, 'print'])->name('transaction.payment.print');
